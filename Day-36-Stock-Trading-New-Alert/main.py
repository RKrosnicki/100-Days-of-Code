...
def daily_stock(stock):
    ...
    todays_close = float(alpha_data[list(days_list)[0]]['4. close'])
    yesterdays_close = float(alpha_data[list(days_list)[1]]['4. close'])
    result = 1 - todays_close/yesterdays_close
